...
const faqData: FAQItemProps[] = [
  {
    ...
    answer:
      "Chrono's Gambit is a decentralized prediction market platform built on the Aptos blockchain. It allows users to create, participate in, and resolve prediction markets on various topics, including politics, climate change, sports, and more, all while enjoying low transaction fees and a user-friendly experience.",
  },
  {
    question: "How does Chrono's Gambit work?",
    answer:
      "Chrono's Gambit leverages the power of blockchain technology to decentralize prediction markets. Users can create markets by defining an event and possible outcomes, then other users can place predictions on those outcomes. The platform uses smart contracts to automate the resolution of these markets, ensuring a fair and transparent process.",
  },
  {
    question: "What makes Chrono's Gambit different from other prediction markets?",
    answer:
      "Chrono's Gambit stands out because of its low transaction fees, thanks to the efficiency of the Aptos blockchain. Additionally, our platform offers a fully decentralized experience, removing the need for intermediaries and ensuring complete transparency and security for all users.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "To start using Chrono's Gambit, you'll need a compatible cryptocurrency wallet. Simply connect your wallet to our platform, deposit some funds, and start creating or participating in prediction markets.",
  },
  {
    question: "What cryptocurrencies are supported on Chrono's Gambit?",
    answer:
      "Chrono's Gambit primarily supports the native Aptos token (APT) for transactions on our platform. We may expand support to other cryptocurrencies in the future.",
  },
  {
